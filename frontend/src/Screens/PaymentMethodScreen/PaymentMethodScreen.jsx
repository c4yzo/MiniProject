                ...
                <div className="container">
                    ...
                    <div className="payment-card">
                        <div className="card-header-custom">
                            <span className="total-badge">Total: $249.00</span>
                            <h2 className="h4 fw-bold mb-1">Payment Method</h2>
                        ...
                        <form className="payment-options" onSubmit={submitHandler}>
                            ...
                            <label className="option-label">
                                ...
                                <div className="option-card">
                                    ...
                                    <div className="option-details">
                                        ...
                                        <span className="option-desc">Fast, secure checkout with your account.</span>
                                    </div>
                            ...
                            <label className="option-label disabled">
                                ...
                                <div className="option-card">
                                    <div className="option-icon-wrapper">
                                        <svg viewBox="0 0 24 24" width="28" height="28" fill="currentColor" xmlns="http://www.w3.org/2000/svg" className="text-secondary">
                                    ...
                                    <div className="option-details">
                                        <span className="option-title text-muted">Apple Pay</span>
                                        <span className="option-desc text-muted">Temporarily unavailable</span>
                                    </div>
                                    <div className="badge-disabled">Disabled</div>
                                </div>
                            </label>
                            ...
                            <label className="option-label disabled">
                                ...
                                <div className="option-card">
                                    ...
                                    <div className="option-details">
                                        <span className="option-title text-muted">Cryptocurrency</span>
                                        <span className="option-desc text-muted">Coming soon</span>
                                    </div>
                                    <div className="badge-disabled">Disabled</div>
                                </div>
                            </label>
                            */}
                            ...
                            <div className="text-center mt-3">
                                <Link to={'/cart'} className="text-decoration-none text-muted small fw-bold">Cancel and return to cart</Link>
                            </div>
